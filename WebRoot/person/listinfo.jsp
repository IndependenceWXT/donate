...
<html>
  <head>
    ...
    function selectchange(index){
   			window.location.href="<%=basePath%>person/listinfo.jsp?status="+index;
    }
	</script>
  </head>
					...
					<br>				 
				        ...
				        <div class="media-body">
							<div class="leftmedia">
								...
								<!-- 活动标题 -->
					        	<span class="media-heading h4"><a class="text-a" href="#">老师病危预捐器官</a></span>
							...
							<div class="rightmedia">
								<div class="small">
									...
									<!-- 进度条数字 -->
									<span class="text-muted number">100%</span> 
								   
									<a class="btn btn-success btn-sm" href="person/detail.jsp">我要参与</a> 
								</div>
							</div>
				        </div>				        
    				</div>
